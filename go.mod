module github.com/BrightDotAi/terraform-provider-s3tables
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/lakeformation v1.47.10 // indirect
...
replace github.com/apache/thrift v0.23.0 => ./patches/thrift
